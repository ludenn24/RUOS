!function (a) {
    ...
    a(function () {
        ...
        $('.subir15').click(function () {
            var b = a(this), dataString;
            var holder = '';
            var exito = true;
            $(".obligate15").each(function () {
                if ($(this).val() == '') {
                    $(this).focus();
                    holder = $(this).attr("data-content");
                    exito = false;
                    $(".msgu15").html("").show();
                    $(".msgu15").html("<div class='alert alert-danger'><i class='fa fa-exclamation-triangle'></i> " + holder + "</div>");
                    setTimeout(function () {
                        $(".msgu15").fadeOut(1500);
                    }, 1500);
                    return false;
            ...
            var formData = new FormData($("#doc15")[0]);

            $.ajax({
                type: "POST",
                url: "../subirdocumentojuveniles",
                data: formData,
                contentType: false,
                processData: false,
                dataType: 'json',
                beforeSend: function () {
                    b.button("Subiendo");
                    $('.subir15').attr("disabled", true);
                    $('.barra15').html("<div class='progress progress-sm active'><div class='progress-bar progress-bar-success progress-bar-striped' role='progressbar' aria-valuenow='20' aria-valuemin='0' aria-valuemax='100' style='width: 100%'><span class='sr-only'>20% Complete</span></div></div>");
                },
                success: function (datos) {
                    if (datos.response == 'success') {
                        $(".subir15").hide();
                        $('.barra15').html(datos.message);
                        if (datos.postulacion == 'full') {
                            jQuery('.popup-overlay').fadeIn('fast', function () {
                                jQuery('.popup-overlay').height(jQuery(window).height());
                                jQuery('#felicitaciones').css('display', 'block');
        ...
        $('.subir16').click(function () {
            var b = a(this), dataString;
            var holder = '';
            var exito = true;
            $(".obligate16").each(function () {
                if ($(this).val() == '') {
                    $(this).focus();
                    holder = $(this).attr("data-content");
                    exito = false;
                    $(".msgu16").html("").show();
                    $(".msgu16").html("<div class='alert alert-danger'><i class='fa fa-exclamation-triangle'></i> " + holder + "</div>");
                    setTimeout(function () {
                        $(".msgu16").fadeOut(1500);
                    }, 1500);
                    return false;
            ...
            if (!exito)
                return false;
            var formData = new FormData($("#doc16")[0]);
            $.ajax({
                type: "POST",
                url: "../subirdocumentojuveniles",
                data: formData,
                ...
                beforeSend: function () {
                    b.button("Subiendo");
                    $('.subir16').attr("disabled", true);
                    $('.barra16').html("<div class='progress progress-sm active'><div class='progress-bar progress-bar-success progress-bar-striped' role='progressbar' aria-valuenow='20' aria-valuemin='0' aria-valuemax='100' style='width: 100%'><span class='sr-only'>20% Complete</span></div></div>");
                },
                success: function (datos) {
                    if (datos.response == 'success') {
                        $(".subir16").hide();
                        $('.barra16').html(datos.message);
                        if (datos.postulacion == 'full') {
                            jQuery('.popup-overlay').fadeIn('fast', function () {
                                jQuery('.popup-overlay').height(jQuery(window).height());
                                jQuery('#felicitaciones').css('display', 'block');
        ...
        $('.subir17').click(function () {
            var b = a(this), dataString;
            var holder = '';
            var exito = true;
            $(".obligate17").each(function () {
                if ($(this).val() == '') {
                    $(this).focus();
                    holder = $(this).attr("data-content");
                    exito = false;
                    $(".msgu17").html("").show();
                    $(".msgu17").html("<div class='alert alert-danger'><i class='fa fa-exclamation-triangle'></i> " + holder + "</div>");
                    setTimeout(function () {
                        $(".msgu17").fadeOut(1500);
                    }, 1500);
                    return false;
            ...
            if (!exito)
                return false;
            var formData = new FormData($("#doc17")[0]);
            $.ajax({
                type: "POST",
                url: "../subirdocumentojuveniles",
                data: formData,
                ...
                beforeSend: function () {
                    b.button("Subiendo");
                    $('.subir17').attr("disabled", true);
                    $('.barra17').html("<div class='progress progress-sm active'><div class='progress-bar progress-bar-success progress-bar-striped' role='progressbar' aria-valuenow='20' aria-valuemin='0' aria-valuemax='100' style='width: 100%'><span class='sr-only'>20% Complete</span></div></div>");
                },
                success: function (datos) {
                    if (datos.response == 'success') {
                        $(".subir17").hide();
                        $('.barra17').html(datos.message);
                        if (datos.postulacion == 'full') {
                            jQuery('.popup-overlay').fadeIn('fast', function () {
                                jQuery('.popup-overlay').height(jQuery(window).height());
                                jQuery('#felicitaciones').css('display', 'block');
